    ...
    <div class="container mt-5">
        ...
        <ul class="list-group">
            ...
            <li class="list-group-item">
                <a href="<?php echo e(url('api/test')); ?>" target="_blank">
                    Test API Endpoint
                </a>
            ...
            <!-- Applications -->
            <li class="list-group-item">
                <a href="<?php echo e(url('api/applications')); ?>" target="_blank">
            ...
            <!-- Audit Logs -->
            <li class="list-group-item">
                <a href="<?php echo e(url('api/audit-logs')); ?>" target="_blank">
                    Audit Logs Endpoint
                </a>
            ...
            <!-- Communications -->
            <li class="list-group-item">
                <a href="<?php echo e(url('api/communications')); ?>" target="_blank">
            ...
            <!-- Diary Reminders -->
            <li class="list-group-item">
                <a href="<?php echo e(url('api/diary-reminders')); ?>" target="_blank">
            ...
            <!-- Expense Statements -->
            <li class="list-group-item">
                <a href="<?php echo e(url('api/expense-statements')); ?>" target="_blank">
            ...
            <!-- Notes -->
            <li class="list-group-item">
                <a href="<?php echo e(url('api/notes')); ?>" target="_blank">
                    Notes Endpoint
                </a>
            ...
            <!-- Payments -->
            <li class="list-group-item">
                <a href="<?php echo e(url('api/payments')); ?>" target="_blank">
                    Payments Endpoint
                </a>
            ...
            <li class="list-group-item">
                <a href="<?php echo e(url('api/users')); ?>" target="_blank">
                    User Role Management
                </a>
                <small class="text-muted">View all users and their roles.</small>
            </li>
            <li class="list-group-item">
                <a href="<?php echo e(url('api/users/{id}/role')); ?>" target="_blank">
                    Update User Role
                </a>
            ...
            <li class="list-group-item">
                <a href="<?php echo e(url('api/login')); ?>" target="_blank">
                    Login Endpoint
                </a>
                <small class="text-muted">Authenticates users and generates tokens (POST).</small>
            </li>
            <li class="list-group-item">
                <a href="<?php echo e(url('api/logout')); ?>" target="_blank">
                    Logout Endpoint
                </a>
...
<?php /**PATH /Users/michaelsowah/projects/directNeedsProgram/direct-needs-backend/resources/views/api-menu.blade.php ENDPATH**/ ?>